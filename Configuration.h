...
#define CUSTOM_MACHINE_NAME "jabcek"
...
//  #define  DEFAULT_Kd 114
    ...
    // Po autotunningu (wajhijev predlog)
  // Ultimaker
...
#define DELTA
  ...
  #define DELTA_SEGMENTS_PER_SECOND 200 //100
  ...
  #define DELTA_SMOOTH_ROD_OFFSET 144.4 // 145.5 mm
  ...
  #define DELTA_PRINTABLE_RADIUS 78
...
//    #define LEFT_PROBE_BED_POSITION -59
//    #define RIGHT_PROBE_BED_POSITION 59
//    #define FRONT_PROBE_BED_POSITION -59
//    #define BACK_PROBE_BED_POSITION 59
    ...
    #define AUTO_BED_LEVELING_GRID_POINTS 5  // 7 JE BLO
      ...
      #define ABL_PROBE_PT_1_Y 180//180
      #define ABL_PROBE_PT_2_X 15
      #define ABL_PROBE_PT_2_Y 20
      #define ABL_PROBE_PT_3_ X 170//170
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER 16   // Z probe to nozzle X offset: -left  +right
  #define Y_PROBE_OFFSET_FROM_EXTRUDER 5   // Z probe to nozzle Y offset: -front +behind
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -6.47  // Z probe to nozzle Z offset: -below (always!) // Večja negativna cifra = bližje plošči
...
//#define Z_PROBE_END_SCRIPT "G1 Z10 F12000\nG1 X15 Y50\nG1 Z0.5\nG1 Z10" // These commands will be executed in the end of G29 routine.
  ...
  #define Z_PROBE_ALLEN_KEY
    ...
    //#define Z_PROBE_ALLEN_KEY_STOW_1_X -64.0 //-64 Move the probe into position
    //#define Z_PROBE_ALLEN_KEY_STOW_1_Y 56.0
    //#define Z_PROBE_ALLEN_KEY_STOW_1_Z 23.0
    //#define Z_PROBE_ALLEN_KEY_STOW_1_FEEDRATE HOMING_FEEDRATE_XYZ
    //#define Z_PROBE_ALLEN_KEY_STOW_2_X -64.0 // -64Push it down
    //#define Z_PROBE_ALLEN_KEY_STOW_2_Y 56.0
    //#define Z_PROBE_ALLEN_KEY_STOW_2_Z 3.0
    //#define Z_PROBE_ALLEN_KEY_STOW_2_FEEDRATE (HOMING_FEEDRATE_XYZ/10)
    //#define Z_PROBE_ALLEN_KEY_STOW_3_X -64.0 //-64 Move it up to clear
    ...
    // Kossel Mini
    #define Z_PROBE_ALLEN_KEY_DEPLOY_1_X 30.0
    #define Z_PROBE_ALLEN_KEY_DEPLOY_1_Y 30.0
    #define Z_PROBE_ALLEN_KEY_DEPLOY_1_Z 30.0
    #define Z_PROBE_ALLEN_KEY_DEPLOY_1_FEEDRATE XY_TRAVEL_SPEED
    #define Z_PROBE_ALLEN_KEY_DEPLOY_2_X -30.0
    #define Z_PROBE_ALLEN_KEY_DEPLOY_2_Y -30.0
    #define Z_PROBE_ALLEN_KEY_DEPLOY_2_Z 30.0
    #define Z_PROBE_ALLEN_KEY_DEPLOY_2_FEEDRATE (XY_TRAVEL_SPEED/10)

    #define Z_PROBE_ALLEN_KEY_STOW_DEPTH 12.5
    // Move the probe into position
    #define Z_PROBE_ALLEN_KEY_STOW_1_X 20.0
...
// For deltabots this means top and center of the Cartesian print volume.
  ...
  #define MANUAL_Z_HOME_POS 230 //250-11.1 For delta: Distance between nozzle and print surface after homing.
#endif
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {200, 200, 200, 186}  // default steps per unit for Kossel (GT2, 20 tooth)
